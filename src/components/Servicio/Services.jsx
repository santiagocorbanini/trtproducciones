        ...
        <section className="page-section bg-primary text-white mb-0 text-center" id="about">
                    ...
                    <div className="container text-black">
                        <div className="row">
                                ...
                                <span className=""><i class="fas fa-guitar fa-lg pr-2"></i> Brindamos todas las comodidades necesarias para que los músicos puedan desarrollar su arte de la mejor manera.</span>
                                <span className=""><i class="fas fa-headphones-alt fa-lg pr-2"></i> Nos encargamos de gestionar la distribución digital del material de nuestros artistas en todas las plataformas digitales.</span>
                                <span className=""><i class="fas fa-clipboard fa-lg pr-2"></i> Junto a ellos, planificamos las salidas de nuevos lanzamentos, singles, videos o álbumes y Hacemos un seguimiento y estudio de las estadísticas para saber en que puntos mejorar, y así lograr los mayores resultados.</span>
