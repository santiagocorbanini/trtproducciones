...
export const ContactUs = () => {
  const form = useRef();
        ...
        const telefonoValido = telefonoCorrecto => {
            return /^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/.test(telefonoCorrecto);
        }
  ...
  const sendEmail = (e) => {
    ...
    if (!telefonoValido(form.current.telefono.value)) {
        ...
        return false;
            ...
            emailjs.sendForm('service_u02fm36', 'template_b0x2ya9', form.current, 'user_kSw3r88rUTBSk2tQWOdl4')
            .then((result) => {
  ...
  return (
    ...
    <div className="container">
        ...
        <h2 className="page-section-heading text-center text-uppercase mb-0">Contacto</h2>
        {/*<!-- Icon Divider-->*/}
        ...
        <div className="row justify-content-center">
            <div className="col-lg-8 col-xl-7">
                ...
                {/*<!-- to get an API token!-->*/}
                <form ref={form} onSubmit={sendEmail} id="contactForm" data-sb-form-api-token="API_TOKEN">
                    {/*<!-- Name input-->*/}
                    ...
                    {/*<!-- Message input-->*/}
                    <div className="form-floating mb-3">
                        <textarea className="form-control" name="mensaje" type="text" defaultValue="" placeholder="Enter your message here..." data-sb-validations="required"></textarea>
