                ...
                <div className="row justify-content-center">
                  <div className="col-lg-8">
                    ...
                    <p className="mb-4 lead">
                      Anticipadas en @woutick (www.woutick.es) A PRECIO
                      PROMOCIONAL POR TIEMPO LIMITADO
                    </p>
                    <p className="mb-4 lead">
                      🃏@guasones llega a #España 🇪🇸 🇦🇷 Una de las bandas
                      argentinas mas solicitadas llegará al Viejo Continente con
                      todos sus hits!
                    </p>
              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-lg-8">
                    ...
                    {/*<!--Portfolio Modal Text -->*/}
                    <p className="mb-4 lead">
                      🎫 Anticipadas a la venta en @woutick ! A VALOR
                      PROMOCIONAL Te lo vas a perder?
                    </p>
                    ...
                    <h6>1 Mayo #Madrid @independanceclub</h6>{" "}
                    {/*<!--Portfolio Modal Button Cerrar -->*/}
                    <button
                      className="btn btn-primary mt-4"
                      type="button"
              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-lg-8">
                    ...
                    {/*<!--Portfolio Modal Text -->*/}
                    <p className="mb-4 lead">
                      ⚠️ YA A LA VENTA ⚠️ 🎟 Ya están las entradas disponibles
                      en: 👉🏼 www.sfx-events.com 💣 @losfundamentalistasok llegan
                      a #España 💣
                    </p>
